...
echo -e "#     \033[96m->\033[0m Backends can be switched by \033[33mpython prodigy/cli.py --engine [ginac | sympy] <target>\033[0m         #"
echo "#                                                                                                    #";
echo "------------------------------------------------------------------------------------------------------";
echo "#                                                                                                    #";
echo -e "#        For more details please visit our Github repository: \033[97m\033[4mhttps://github.com/LKlinke/prodigy\033[0m     #";
echo "#   (C) Lutz Klinkenberg, Christian Blumenthal, Mingshuai Chen, Darion Haase, Joost-Pieter Katoen    #";
echo "------------------------------------------------------------------------------------------------------";
echo
