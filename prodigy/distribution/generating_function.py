...
import functools
import operator
from typing import Callable, Dict, Generator, List, Set, Union, get_args
...
State = Dict[str, int]
""" A program state is a mapping from variables (represented by strings) to valuations (currently only integers)."""
