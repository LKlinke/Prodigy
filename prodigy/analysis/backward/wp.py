...
[kam19]_), which are given by :class:`prodigy.pgcl.ast.TickInstr` and
represented in the computed expectations as a
:class:`prodigy.pgcl.ast.TickExpr`.
...
can be obtained by simply ignoring all :class:`prodigy.pgcl.ast.TickExpr` in
...
our AST (see :mod:`prodigy.pgcl.ast`), but instead represent the weakest
...
:func:`prodigy.pgcl.cfg.program_one_big_loop` to transform arbitrarily structured
...
def loopfree_wp(instr: Union[Instr, Sequence[Instr]],
    ...
    .. todo::
        ...
        We do this because the :mod:`prodigy.pgcl.substitute` module cannot yet handle non-tree ASTs.
...
class ExpectationTransformer:
    ...
    :class:`prodigy.pgcl.ast.Expr`) and holds a reference to a variable
    ...
    The :mod:`prodigy.pgcl.simplify` module can translate expectation
    transformers into *summation normal form*. See
    :class:`prodigy.pgcl.simplify.SnfExpectationTransformer` and
    :func:`prodigy.pgcl.simplify.normalize_expectation_transformer`.
    """
    ...
    def substitute(self) -> 'ExpectationTransformer':
        """
        Apply all :class:`prodigy.pgcl.ast.SubstExpr` using
        :func:`prodigy.pgcl.substitute.substitute_expr`, keeping
...
class LoopExpectationTransformer:
    ...
    rather just an expectation (:class:`prodigy.pgcl.ast.Expr`). This is
...
def general_wp_transformer(
    ...
    run through :func:`prodigy.pgcl.cfg.program_one_big_loop` first and then
